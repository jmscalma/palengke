            ...
            // console.log(product_id)
                ...
                .then(product => {
                    ...
                    <div class="product_details">
                        <span class="close" onclick="window.closeOrderModal()">&times;</span>
                        <img class="product_image" src="/images/${product[0].name}.png" alt="${product[0].name}">
                        <h2 class="product_name">${product[0].name}</h2>
                        <p class="product_price">Php ${product[0].price}</p>
                    </div>
                    <div class="customer_details">
                        <input type="text" id="buyer_name" placeholder="Name of Buyer">
                        <input type="email" id="buyer_email" placeholder="Email address">
                        <input type="text" id="buyer_mobile" placeholder="Mobile #">
